...
const SchoolLevelCard = ({ level, onLearnMore }) => {
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 max-w-xs mx-auto border-[#C8C8C8] border-1">
      {/* Image Container */}
      ...
      <div className="p-5">
        ...
        <div className="text-center">
          <button
            ...
            className="text-gray-500 text-xs hover:text-purple-500 transition-colors duration-200 font-medium border-[#C8C8C8] border-1 rounded-full px-4 py-2"
          >
            {level.buttonText}
          </button>
        </div>
...
const JenjangSekolah = () => {
  ...
  return (
    <div className="w-full py-12 px-4 bg-white pb-30 border-b-1 border-[#C8C8C8]">
      {/* Main Container */}
